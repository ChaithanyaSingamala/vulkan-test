...
int main(const int argc, const char *argv[])
{
	...
	printf("\n aaaaaaaaaaaaa 11111111111111111111111\n");
	vulkanExample = new VulkanExample();
	printf("\n aaaaaaaaaaaaa 2222222222222222222222222\n");
	vulkanExample->initVulkan();
	printf("\n aaaaaaaaaaaaa 33333333333333333333333\n");
	vulkanExample->initSwapchain();
	printf("\n aaaaaaaaaaaaa 4444444444444444444\n");
	vulkanExample->prepare();
	printf("\n aaaaaaaaaaaaa 55555555555555555555555555555\n");
	vulkanExample->renderLoop();
	printf("\n aaaaaaaaaaaaa 66666666666666666666666\n");
